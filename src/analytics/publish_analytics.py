...
Usage:
    python -m src.analytics.publish_analytics            # build + publish
    python -m src.analytics.publish_analytics --dry-run  # build + print manifest only
"""
...
from src.analytics import returns as RET
from src.attribution.attribute import _folds_by_granularity

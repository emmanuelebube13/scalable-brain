...
Usage:
    python -m src.system1.serializer.publish_gatekeeper            # publish live champion (gated)
    python -m src.system1.serializer.publish_gatekeeper --force    # publish even if not better
    python -m src.system1.serializer.publish_gatekeeper --dry-run  # publish PROPOSED bundle instead
"""

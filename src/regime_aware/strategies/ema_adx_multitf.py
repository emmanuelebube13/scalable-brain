"""Regime-aware port of Trend_EMA_ADX_MultiTF."""
...
from src.layer0.strategies.strategieStaged.trend_ema_adx import TrendEMAADX_MultiTF
...
class RegimeAwareEMAADXMultiTF(TrendEMAADX_MultiTF):
    def __init__(self, params: RegimeParams, name: str = "Trend_EMA_ADX_MultiTF_RA"):
        super().__init__()
        self.params = params
...
def build_baseline() -> RegimeAwareEMAADXMultiTF: return RegimeAwareEMAADXMultiTF(RegimeParams.uniform(BASELINE), "Trend_EMA_ADX_MultiTF_blind")
def build_regime_aware() -> RegimeAwareEMAADXMultiTF: return RegimeAwareEMAADXMultiTF(REGIME_AWARE, "Trend_EMA_ADX_MultiTF_RA")
def build_trend_aware() -> RegimeAwareEMAADXMultiTF: return RegimeAwareEMAADXMultiTF(TREND_AWARE, "Trend_EMA_ADX_MultiTF_TA")

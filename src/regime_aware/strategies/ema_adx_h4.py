"""Regime-aware port of Trend_EMA_ADX_H4."""
...
from src.layer0.strategies.strategieStaged.trend_ema_adx import TrendEMAADX_H4_Only
...
class RegimeAwareEMAADXH4(TrendEMAADX_H4_Only):
    def __init__(self, params: RegimeParams, name: str = "Trend_EMA_ADX_H4_RA"):
        super().__init__()
        self.params = params
...
def build_baseline() -> RegimeAwareEMAADXH4: return RegimeAwareEMAADXH4(RegimeParams.uniform(BASELINE), "Trend_EMA_ADX_H4_blind")
def build_regime_aware() -> RegimeAwareEMAADXH4: return RegimeAwareEMAADXH4(REGIME_AWARE, "Trend_EMA_ADX_H4_RA")
def build_trend_aware() -> RegimeAwareEMAADXH4: return RegimeAwareEMAADXH4(TREND_AWARE, "Trend_EMA_ADX_H4_TA")

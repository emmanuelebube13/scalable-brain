"""Regime-aware port of Range_Bollinger_Aggressive."""

from __future__ import annotations
from typing import Dict, List
import pandas as pd
from src.layer0.data_access.indicators import bollinger_bands, rsi, atr
from src.layer0.strategies.strategieStaged.range_bollinger import RangeBollinger_Aggressive
...
class RegimeAwareBollingerAggressive(RangeBollinger_Aggressive):
    def __init__(self, params: RegimeParams, name: str = "Range_Bollinger_Aggressive_RA"):
        super().__init__()
        self.params = params
...
def build_baseline() -> RegimeAwareBollingerAggressive: return RegimeAwareBollingerAggressive(RegimeParams.uniform(BASELINE), "Range_Bollinger_Aggressive_blind")
def build_regime_aware() -> RegimeAwareBollingerAggressive: return RegimeAwareBollingerAggressive(REGIME_AWARE, "Range_Bollinger_Aggressive_RA")
def build_trend_aware() -> RegimeAwareBollingerAggressive: return RegimeAwareBollingerAggressive(TREND_AWARE, "Range_Bollinger_Aggressive_TA")

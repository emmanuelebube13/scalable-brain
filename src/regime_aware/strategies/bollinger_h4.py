"""Regime-aware port of Range_Bollinger_H4."""

from __future__ import annotations
from typing import Dict, List
import pandas as pd
from src.layer0.data_access.indicators import bollinger_bands, rsi, atr
from src.layer0.strategies.strategieStaged.range_bollinger import RangeBollinger_H4_Only
...
class RegimeAwareBollingerH4(RangeBollinger_H4_Only):
    def __init__(self, params: RegimeParams, name: str = "Range_Bollinger_H4_RA"):
        super().__init__()
        self.params = params
...
def build_baseline() -> RegimeAwareBollingerH4: return RegimeAwareBollingerH4(RegimeParams.uniform(BASELINE), "Range_Bollinger_H4_blind")
def build_regime_aware() -> RegimeAwareBollingerH4: return RegimeAwareBollingerH4(REGIME_AWARE, "Range_Bollinger_H4_RA")
def build_trend_aware() -> RegimeAwareBollingerH4: return RegimeAwareBollingerH4(TREND_AWARE, "Range_Bollinger_H4_TA")

"""Regime-aware port of Trend_Donchian_H4."""

from __future__ import annotations
from typing import Dict, List
import pandas as pd
from src.layer0.data_access.indicators import adx, atr, donchian_channel
from src.layer0.strategies.strategieStaged.trend_donchian import TrendDonchian_H4_Only
...
class RegimeAwareDonchianH4(TrendDonchian_H4_Only):
    def __init__(self, params: RegimeParams, name: str = "Trend_Donchian_H4_RA"):
        super().__init__()
        self.params = params
...
def build_baseline() -> RegimeAwareDonchianH4:
    return RegimeAwareDonchianH4(RegimeParams.uniform(BASELINE), name="Trend_Donchian_H4_blind")

def build_regime_aware() -> RegimeAwareDonchianH4:
    return RegimeAwareDonchianH4(REGIME_AWARE, name="Trend_Donchian_H4_RA")

def build_trend_aware() -> RegimeAwareDonchianH4:
    return RegimeAwareDonchianH4(TREND_AWARE, name="Trend_Donchian_H4_TA")

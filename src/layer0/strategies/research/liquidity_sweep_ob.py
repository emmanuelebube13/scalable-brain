...
# O-28 / F9b: measured stop/ATR 0.813 of its non-JPY value on USD_JPY before this
# fix (priority 3 — its non-JPY mean is already weak, so this is not its main
# problem, but the idiom is still wrong). Fallback only, for callers that do not
# pass `pair`.

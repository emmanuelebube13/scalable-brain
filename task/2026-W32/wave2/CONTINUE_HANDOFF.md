...
**`task/2026-W32/wave2/RUN_BRIEF.md` is the authoring specification.** Read it in full before
...
| Report | `task/2026-W32/wave2/REPORT-<id>.md` |

Work **one strategy at a time, start to finish**, and append a line to
`task/2026-W32/wave2/PROGRESS.md` after each. Write each file in a single write operation — a
...
```bash
python task/2026-W32/wave2/audit_wave2.py --quick <id>   # while iterating
python task/2026-W32/wave2/audit_wave2.py <id>           # full, incl. database
```
...
python task/2026-W32/wave2/risk_audit.py <id>
```
...
python task/2026-W32/wave2/risk_audit.py
```
...
- Project history, every hand correction and why: `task/2026-W32/wave2/STATE.md`.

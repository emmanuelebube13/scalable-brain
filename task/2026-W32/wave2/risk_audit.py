...
Usage:
    python task/2026-W32/wave2/risk_audit.py            # every strategy with a report
    python task/2026-W32/wave2/risk_audit.py <id> ...   # named strategies
    python task/2026-W32/wave2/risk_audit.py --json     # machine-readable
"""

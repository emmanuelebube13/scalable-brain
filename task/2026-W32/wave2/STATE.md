...
**Run brief given to each agent:** `task/2026-W32/wave2/RUN_BRIEF.md` (in-repo; the original
...
`task/2026-W32/wave2/REPORT-<id>.md`, which the **orchestrator** writes from the agent's
...
`task/2026-W32/wave0/DATA_GAP_REGISTER.md` collates 20 gap notes. Most say "implement now

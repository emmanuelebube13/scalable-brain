...
```bash
python task/2026-W32/wave2/audit_wave2.py --quick kiss_h4 janus_swing_system kpl_donchian_breakout
```
...
| The full rules | `task/2026-W32/wave2/RUN_BRIEF.md` |
...
`task/2026-W32/fleet/upload/wave2/specs/SPEC-<id>.md`
...
Path: `task/2026-W32/wave2/REPORT-<id>.md`
...
Append one line to `task/2026-W32/wave2/GEMINI_PROGRESS.md`:
...
1. **Only ever create or edit these three files per strategy:**
   ...
   `task/2026-W32/wave2/REPORT-<id>.md`.
...
```bash
python task/2026-W32/wave2/audit_wave2.py
```
...
```bash
python task/2026-W32/wave2/audit_wave2.py --quick <id>
```
...
- `task/2026-W32/wave2/REPORT-bb_midline_break.md`
...
`task/2026-W32/wave2/REPORT-<id>.md`, using the four sections from Step 5 and describing what
...
Then write a final summary in `task/2026-W32/wave2/GEMINI_PROGRESS.md`: how many strategies

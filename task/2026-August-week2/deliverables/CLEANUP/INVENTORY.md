...
**Precedent:** T7 (`task/2026-July-week4/T7-archive-v1-cleanup.md`)
...
| `sandbox-handoff/` | 80 K | 2026-08-09 | no | nothing in repo | **ARCHIVE** — blind-protocol brief for external agents; superseded by `task/2026-August-week1/fleet/` |
...
**2. `task/2026-July-week4/` was moved to `task/archive/`, then moved back.**
...
`task/2026-July-week4/T5-fix-package/` five times). Rewriting sent messages so they match a

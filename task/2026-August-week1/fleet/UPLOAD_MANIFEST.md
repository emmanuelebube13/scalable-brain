...
**Prompt:** `task/2026-August-week1/fleet/WAVE0_SPEC_EXTRACTION.md`
...
| Data availability | `task/2026-August-week1/fleet/DATA_AVAILABILITY.md` |
| Indicator inventory | `task/2026-August-week1/fleet/INDICATOR_INVENTORY.md` |
...
**Prompt:** `task/2026-August-week1/fleet/WAVE1_ENGINE_BUILD.md`
...
| Look-ahead findings | `task/2026-August-week1/lookahead-audit/FINDINGS.md` | why swings are banned |
| Existing tests | `src/layer0/strategies/tests/` | must keep passing |
| Data availability | `task/2026-August-week1/fleet/DATA_AVAILABILITY.md` | pairs/granularities |
...
**Prompt:** `task/2026-August-week1/fleet/WAVE2_STRATEGY_AUTHORING.md`

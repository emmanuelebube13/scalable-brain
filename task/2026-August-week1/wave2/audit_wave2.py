...
Usage:
    ...
    python task/2026-August-week1/wave2/audit_wave2.py                 # everything on disk
    python task/2026-August-week1/wave2/audit_wave2.py --quick         # skip step 8 (no DB, much faster)
    python task/2026-August-week1/wave2/audit_wave2.py kiss_h4 ...     # only these ids

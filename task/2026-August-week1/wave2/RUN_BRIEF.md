...
1. `task/2026-August-week1/fleet/upload/wave2/PROMPT.md` — the fleet brief. **Every hard rule in it
...
2. **Your spec**, in full: `task/2026-August-week1/fleet/upload/wave2/specs/SPEC-<id>.md`.
...
`task/2026-August-week1/wave2/REPORT-<id>.md` verbatim. Do not route around the guard with `bash`
...
- If your target files already exist when you start, they are an **untrusted draft from the
  ...
  parked in `task/2026-August-week1/wave2/aborted-run1-partials/`; they are unverified and must not
...
## `task/2026-August-week1/wave2/REPORT-<id>.md` — four sections, short

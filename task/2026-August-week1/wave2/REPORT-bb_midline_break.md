...
**Spec:** `task/2026-August-week1/fleet/upload/wave2/specs/SPEC-bb_midline_break.md` (CSV row 28)
...
- The aborted-run draft in `task/2026-August-week1/wave2/aborted-run1-partials/bb_midline_break.py`

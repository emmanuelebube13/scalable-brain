...
> **First action: read `task/2026-July-week4/STATE.md`.** T1 should be DONE (so "outcomes fresh" is a meaningful assertion); if not, build the script anyway but mark the outcomes check `KNOWN-STALE until T1`.
...
Write to `task/2026-July-week4/deliverables/T4/`:

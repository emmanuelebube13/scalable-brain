...
> **First action: read `task/2026-July-week4/STATE.md`.** Requires T1 = DONE (builds directly on the repaired `src/layer0/strategies` package). This is the week's innovation track — design fully, implement the skeleton; the full engine may extend past this week and that is fine.
...
Write to `task/2026-July-week4/deliverables/T6/`:

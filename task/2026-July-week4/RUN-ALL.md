...
> It is safe to paste repeatedly: state lives in `task/2026-July-week4/STATE.md` and every run resumes
> from where the last one stopped.

## Your role

You are the week's engineering lead. You will execute tasks T1–T6 in `task/2026-July-week4/` in
...
1. Read `task/2026-July-week4/STATE.md` in full. Note every DONE step and every BLOCKED item.
2. Read `task/2026-July-week4/README.md` ground rules. They override convenience at all times.
...
4. Produce the task's **Deliverables** section in full — `DELIVERABLE.md`, the named PNG
   visuals (matplotlib, `Agg` backend, saved to `task/2026-July-week4/deliverables/<task>/`), and
...
Write `task/2026-July-week4/deliverables/WEEK-EXECUTIVE-SUMMARY.md` — max 2 pages, for the system
...
Write `task/2026-July-week4/RUN-REPORT-<date>.md` and print its contents:

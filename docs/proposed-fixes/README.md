...
| FIX-S1-006 | Retrain deployment gates `oos_uplift_ok` & `beats_incumbent` never reject | System 1 | **P1** | Proposed | — | [link](system-1/FIX-S1-006-deployment-gates-never-reject.md) |

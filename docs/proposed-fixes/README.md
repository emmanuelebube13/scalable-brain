...
| FIX-S1-004 | Per-regime weights collapse on duplicate strategy_id (Ranging weight 5e-8, not 1.0) | System 1 | **P0** | Proposed | — | [link](system-1/FIX-S1-004-weights-collapse-duplicate-strategy-id.md) |
